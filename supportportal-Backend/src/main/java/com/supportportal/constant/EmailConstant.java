...
public class EmailConstant {
	 ...
	 public static final String USERNAME = "hdhia46@gmail.com";
	 public static final String PASSWORD = "kyfb hbge wczx tzyt";
	 public static final String FROM_EMAIL = "support@getarrays.com";
	 public static final String CC_EMAIL ="";
	 public static final String EMAIL_SUBJECT = "New Password--Data_Gov";
