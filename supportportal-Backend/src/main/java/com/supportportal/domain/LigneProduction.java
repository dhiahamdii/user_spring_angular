...
public class LigneProduction implements Serializable {
    ...
    @OneToMany(mappedBy = "ligneProduction")
    ...
    public LigneProduction(Long idLigneProd, String codeLp, String robotTraitement, String operation,
			String observation, Date dateMaj, Boolean status, List<Produit> produits, List<Poste> postes,
			UniteFabrication uniteFab) {
		super();
