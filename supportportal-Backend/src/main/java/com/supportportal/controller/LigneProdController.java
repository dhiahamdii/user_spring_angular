...
public class LigneProdController  extends ExceptionHandling  {
	...
	public ResponseEntity<LigneProduction> addNewLigneProd(@RequestParam("codeLp") String codeLp,
		...
		LigneProduction newLigneProd = ligneProdService.addLigneProd(codeLp, robotTraitement,operation, observation,  Boolean.parseBoolean(status), codeUf) ;
	...
	public ResponseEntity<LigneProduction> updateLigneProd(@RequestParam("codeLp") String codeLp,
		...
		LigneProduction ligneProd = ligneProdService.updateLigneProd( codeLp, robotTraitement,operation, Boolean.parseBoolean(status) ) ;
