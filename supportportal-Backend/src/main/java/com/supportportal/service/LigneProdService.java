...
public interface LigneProdService {
	...
	LigneProduction addLigneProd(String codeLp, String robotTraitement, String observation,String operation, boolean status, String codeUf) throws CodeLigneProdExistException, LigneProdNotFoundException, UniteFabNotFoundException;
	...
	LigneProduction updateLigneProd( String codeLp, String robotTraitement, String operation, boolean status) throws CodeLigneProdExistException, LigneProdNotFoundException, UniteFabNotFoundException ;
