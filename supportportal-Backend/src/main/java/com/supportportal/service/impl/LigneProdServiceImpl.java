...
public class LigneProdServiceImpl implements LigneProdService{
	...
	@Override
	public LigneProduction addLigneProd(String codeLp, String robotTraitement, String observation,String operation, boolean status, String codeUf ) 
		...
		ligneProd.setOperation(operation);
	...
	@Override
	public LigneProduction updateLigneProd( String codeLp, String robotTraitement , String operation,  boolean status) throws CodeLigneProdExistException, LigneProdNotFoundException, UniteFabNotFoundException {
